...
while($pr_item_row=mysqli_fetch_row($pr_item_result)){
    ...
    echo("<tr><td>$pr_item_row[0]</td><td>$pr_item_row[1]</td><td>$pr_item_row[2]</td><td>$pr_item_row[3]</td><td>$tot_price</td><td><button class=\"btn btn-success confirmbtn\" onclick='confirmbtn(this)'>Confirm</button><button class=\"btn btn-danger deletebtn\">Delete</button></td></tr>");
