...
while($t_id_row=mysqli_fetch_row($t_id_result)){
    ...
    echo ("<tr><td>$tire_size</td><td>$req_qty</td><td><input type='number' id='sup_qty' value=\"$req_qty\"></td><td><input type='number' id='unit_price'></td><td></td><td><button class='btn btn-success sendbtn' >Send</button></td></tr>");
}
