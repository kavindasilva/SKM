...
while($row=mysqli_fetch_array($result)){
	...
	echo("<tr class=\"removable bg-success\"><td><input type=checkbox disabled></td><td>".$rowinside['brand_name']."</td><td>".$rowinside['country']."</td><td>".$rowinside['tire_size']."</td><td>".$rowinside['unit_price']."</td><td>".$row['qty']."</td><td>$tot</td><td>".$row['status']."</td></tr>");		
	}
	else{
