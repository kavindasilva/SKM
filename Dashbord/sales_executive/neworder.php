  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li  id="dd"class=" treeview menu-open">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i> New Order</a></li>
...
<form id="addtiresform" action="#" method="post">
 <div class="selectitempanal container pull-left" style="margin-left: 23px;">
 	...
 	<select class="form-control" name="country" >
 	 ...
 	 <div class="col-xs-6">
 	<select class="form-control" name="tiresize" >
        <option value="" >Select</option>
 	 ...
 	 <div class="col-xs-6">
 	<input name="quantity" type="text" placeholder="Quantity" required="" class="form-control input-md">
      </select></div></div></br>
        ...
        <div  class="col-xs-12" style="width: auto; margin-left: 72px">
          <div class="box" >
            ...
            <div class="col-md-3">
            	...
            	<button type="submit" class="btn btn-primary" style="width: 153px">Place Order</button>
            	</div>
